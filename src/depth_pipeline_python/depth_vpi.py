...
class Depth(Thread):
    def __init__(self, img_r, img_l):
        ...
        left = cv2.imread(img_l)
        right = cv2.imread(img_r)
        left_arr = np.array(left)
        right_arr = np.array(right)
        self.img_r = right_arr
        self.img_l = left_arr
...
if __name__ == "__main__":
    ...
    img_l = "/home/james/edge-ml/src/calib/calib_images/left/001.png"
    img_r = "/home/james/edge-ml/src/calib/calib_images/right/001.png"
    depth = Depth(img_l, img_r)
    ...
    for i in range(10):
        ...
        if DISPLAY:
            ...
            cv2.imshow("Image", cv2.resize(img_l, (480, 270)))
            cv2.waitKey(1)
