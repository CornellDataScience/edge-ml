    ...
    def load(self, set_name):
        ...
        for line in tqdm.tqdm(lines):
            ...
            if len(line) == 4:  # Class 0 - non-identical
                ...
                first_image = self.convert_image_to_array(
                    person=first_person_name,
                    image_num=first_image_num,
                    data_path=self.data_path,
                )
                second_image = self.convert_image_to_array(
                    person=second_person_name,
                ...
                names.append(line)
                person_name, first_image_num, second_image_num = (
                    line[0],
                    line[1],
                    line[2],
                )
